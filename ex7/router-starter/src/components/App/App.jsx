...
const NavBar = () => {
  ...
  return (
    <nav>
      <Link to={`/`} style={{color : "white"}} className="link"> | Home </Link>{" "}
      <Link to={`/cinema`} style={{color : "white"}} className="link">| Cinema </Link>{" "}
      <Link to={`/movie`} style={{color : "white"}} className="link">| MoviesList </Link>{" "}
      <Link to={`/movie/add`} style={{color : "white"}} className="link">| Add Movie |</Link>{" "}
    </nav>
  );
};
